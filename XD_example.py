...
Modified slightly by AJ for ASP5048
"""
...
#------------------------------------------------------------
# cfuncion para estimar el GMM
def compute_XD_results(n_components=10, n_iter=200):
...
# Actividad: calcule y plotee el BIC en funcion del numero de componentes Gaussianas
# ngauss para ngauss=1,..,20.
# haga un plot como el de arriba para cada valor de ngauss. Que valor de ngauss es 
# optimo segun BIC?
